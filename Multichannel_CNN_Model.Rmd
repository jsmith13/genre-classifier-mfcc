...
output_layers <- layer_average(regional_layers) %>%
...
Things to try:
- gradient descent without decay
- concatenation in place of joining during merge layer
- increased capacity, particularly in dense layers
