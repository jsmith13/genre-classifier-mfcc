...
When trained with the entire 10s segment at once, this single channel model gives ~50% validation set accuracy by epoch ~10 before starting to overfit the training data.

When trained using 3s segments, this model gives ~50% validation set accuracy by epoch ~7 before starting to overfit the training data.
