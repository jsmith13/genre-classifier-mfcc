...
MFCC_descriptors.1 <- foreach (row = 1:700, .combine = rbind, .packages = c("tuneR", "seewave")) %dopar% {
  ...
  descriptors <- rep(NA, 191618)
  names(descriptors) <- c("song", "genre",
        outer(outer(outer("MFCC.V", 1:64, FUN = paste, sep = ""), 1:998, FUN = paste, sep = "."), 
  ...
  descriptors[outer(outer(outer("MFCC.V", 1:64, FUN = paste, sep = ""), 1:998, FUN = paste, sep = "."), "start", FUN = paste, sep = ".")] <- c(melfcc(wave.start, numcep = 64))
  descriptors[outer(outer(outer("MFCC.V", 1:64, FUN = paste, sep = ""), 1:998, FUN = paste, sep = "."), "mid", FUN = paste, sep = ".")] <- c(melfcc(wave.mid, numcep = 64))
  descriptors[outer(outer(outer("MFCC.V", 1:64, FUN = paste, sep = ""), 1:998, FUN = paste, sep = "."), "end", FUN = paste, sep = ".")] <- c(melfcc(wave.end, numcep = 64))
